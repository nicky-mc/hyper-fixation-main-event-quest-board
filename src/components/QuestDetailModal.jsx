import { X, Trash2, MessageCircle, CheckCircle } from 'lucide-react';
  ...
  return (
    ...
    >
      <motion.div
        ...
        className="w-full max-w-2xl max-h-[90vh] overflow-y-auto rounded-2xl border-2 border-purple-700/60 shadow-2xl"
